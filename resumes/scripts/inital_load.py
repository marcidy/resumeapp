...
def run():
    ...
    acs_list_items = [md.CVListItem(text='Design operation and business \
                                    process for a Top 4 consulting firm\'s \
                                    crowdsourcing unit, including work-flows \
                                    and analytics'),
                      md.CVListItem(text='Investigate and model statistical \
    ...
    mrm_items = [md.CVListItem(text='Migrated several client specific products \
                               to single master branch'),
                 md.CVListItem(text='Approved final sign-off for client \
                               deliverables'),
                 md.CVListItem(text='Rejected low quality developments and \
                               releases')]
    ...
    mcrm_items = [md.CVListItem(text='Gained reputation for handling difficult \
                                clients and turning around unhappy users'),
                  md.CVListItem(text='Cooperated on multiple client and \
                                product teams'),
                  md.CVListItem(text='Managed resource competition and client \
                                priorities'),
                  md.CVListItem(text='Provided agency for client or Murex \
                                to optimize utilization of resources'),
                  md.CVListItem(text='Resolve conflicts between product \
                                development and project deliverables'),
                  md.CVListItem(text='Query end users and develop feedback \
                                process to enhance overall product'),
                  md.CVListItem(text='Negotiated with end users to gain \
    ...
    edf_cvlist_items = [md.CVListItem(text='Built and maintained compute \
                                      clusters for physics applications'),
                        md.CVListItem(text='Designed, prototyped, and built \
                                      waveform digitizer for particle \
                                      detectors'),
                        md.CVListItem(text='Designed and fabricated aluminum \
                                      enclosures and face-plates using AutoCAD'),
                        md.CVListItem(text='One of 4 full-time Engineers')]
    ...
    pers_list = md.CVListHeading(
        items=[
            md.CVListItem(text='Ask me about my website idea!'),
            md.CVListItem(text='I love to ride my bikes (plural, though \
